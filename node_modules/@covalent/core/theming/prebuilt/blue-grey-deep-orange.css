...
[dir='rtl'] .mat-calendar-body-comparison-bridge-end::before {
  background: -webkit-gradient(linear, left top, right top, color-stop(50%, rgba(69, 90, 100, 0.2)), color-stop(50%, rgba(249, 171, 0, 0.2)));
  background: linear-gradient(to right, rgba(69, 90, 100, 0.2) 50%, rgba(249, 171, 0, 0.2) 50%); }

.mat-calendar-body-comparison-bridge-end::before,
[dir='rtl'] .mat-calendar-body-comparison-bridge-start::before {
  background: -webkit-gradient(linear, right top, left top, color-stop(50%, rgba(69, 90, 100, 0.2)), color-stop(50%, rgba(249, 171, 0, 0.2)));
...
.mat-calendar-body-today.mat-calendar-body-selected {
  -webkit-box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.87);
...
.mat-datepicker-content {
  ...
  .mat-datepicker-content.mat-accent [dir='rtl'] .mat-calendar-body-comparison-bridge-end::before {
    background: -webkit-gradient(linear, left top, right top, color-stop(50%, rgba(255, 87, 34, 0.2)), color-stop(50%, rgba(249, 171, 0, 0.2)));
    background: linear-gradient(to right, rgba(255, 87, 34, 0.2) 50%, rgba(249, 171, 0, 0.2) 50%); }
  .mat-datepicker-content.mat-accent .mat-calendar-body-comparison-bridge-end::before,
  .mat-datepicker-content.mat-accent [dir='rtl'] .mat-calendar-body-comparison-bridge-start::before {
    background: -webkit-gradient(linear, right top, left top, color-stop(50%, rgba(255, 87, 34, 0.2)), color-stop(50%, rgba(249, 171, 0, 0.2)));
...
.td-steps .td-step-header .td-step-label-wrapper.mat-inactive,
.td-steps .td-step-header .td-step-label-wrapper.mat-inactive * {
  color: rgba(0, 0, 0, 0.38); }

.td-steps .td-step-header .td-step-label-wrapper.mat-warn,
.td-steps .td-step-header .td-step-label-wrapper.mat-warn * {
  color: #e53935; }
...
.td-expansion-panel {
  ...
  .td-expansion-panel .td-expansion-panel-header .td-expansion-panel-header-content mat-icon.td-expand-icon {
    color: rgba(0, 0, 0, 0.54); }
  .td-expansion-panel .td-expansion-panel-header .td-expansion-panel-header-content.mat-disabled,
  .td-expansion-panel .td-expansion-panel-header .td-expansion-panel-header-content.mat-disabled * {
    color: rgba(0, 0, 0, 0.38); }
  .td-expansion-panel mat-icon.td-expand-icon {
    color: rgba(0, 0, 0, 0.54); }
  .td-expansion-panel .td-expansion-label,
  .td-expansion-panel .td-expansion-label *,
...
td-paging-bar,
td-paging-bar mat-select .mat-select-value {
  color: rgba(0, 0, 0, 0.54); }
...
/*# sourceMappingURL=blue-grey-deep-orange.css.map */
